...
update-python-abi:	clients/python/resources/compiled-contracts/NeutralValidator.json \
  			clients/python/resources/compiled-contracts/ERC20Detailed.json
...
clients/python/resources/compiled-contracts/ERC20Detailed.json: compiled-contracts/ERC20Detailed.json
	@cp -f compiled-contracts/ERC20Detailed.json $@
	git add $@
