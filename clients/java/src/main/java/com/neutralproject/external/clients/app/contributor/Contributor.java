...
public class Contributor {
  ...
  public static void main(String [] args) throws Throwable {
    ...
    UserQuoteProcessor userQuoteProcessor = new UserQuoteProcessor() {
      private NeutralSettler settler = new NeutralSettler(config, credentials);
      @Override
      public void process(SignedUserQuote signedUserQuote) {
        ...
        if (!inContributionWindow) {
          System.err.println("[WARN] Not in contribution window.");
          //return;  // uncomment this out for real contribution behavior.
        }
        try {
