...
public class NeutralClientConfig {
  ...
  public NeutralClientConfig(String host, Integer port, Boolean secure, String ethNode, Long gasPrice, Long gasLimit) {
    this(host, port, secure, ethNode, gasPrice, gasLimit, "");
  }

  public NeutralClientConfig(String host, Integer port, Boolean secure, String ethNode, Long gasPrice, Long gasLimit, String certificateName) {
    this.host = host;
    this.port = port;
    this.secure = secure;
