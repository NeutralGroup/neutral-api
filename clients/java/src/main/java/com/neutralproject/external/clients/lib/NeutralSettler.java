...
public class NeutralSettler {
  ...
  public NeutralSettler(String neutralContractAddress, NeutralClientConfig config, Credentials credentials) {
    System.out.println("Creating a NeutralSettler against " + neutralContractAddress + " via " + config.ethNode);
    this.abi = NeutralTokenAbi.load(
        neutralContractAddress,
